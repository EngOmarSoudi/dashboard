                      ...
                      <div class="row no-no-gutters ">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select class="form-control" v-model="form.others_categories_id"  :class="{ 'is-invalid': form.errors.has('others_categories_id') }">
                                <option v-for="item in categories" :key="item.id" :value="item.id">{{item.title}}</option>
                            </select>
                            <span v-if="errors.others_categories_id" class="error">{{ errors.others_categories_id[0] }}</span>
                          </div>
                          <div class="form-group">
                            <label>Title</label>
  ...
  methods: {
    ...
    upload_image(e) {
     ...
     displayCategoriesItems() {
            axios.get("api/others_categories").then(response => {
    ...
    creating() {
      ...
      formData.append("others_categories_id", this.form.others_categories_id);
      formData.append("_method", "put");
      let id = this.$route.params.id;
      axios
        .post("api/others/" + id, formData, {
          headers: {
        ...
        .then((res) => {
          ...
          this.$router.push({ path: "/admin/others/" });
          Toast.fire({
            icon: "success",
    ...
    loadItem() {
      let id = this.$route.params.id;
      axios.get("api/others/" + id).then((response) => {
