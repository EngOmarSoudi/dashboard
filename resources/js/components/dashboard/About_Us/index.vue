            ...
            <div class="col-12 ">
              <div class="head-fixed">
                <div class="min-div px-4 py-3">
                  ...
                  <div class="min-div_list_icon">
                    ...
                    <router-link to="/admin/about-us/create">
              ...
              <div class="min-div px-4 py-3 my-5">
                ...
                <div class="min-div_list_item mt-4">
                  <div class=" row no-gutters my-4 " v-for="(item, i) in filteredList" :key="i">
                    <img class="min-div_list_item_img col-md-3" :src="'images/about_us/'+ item.photo.filename" />
                          ...
                          <form>
                            ...
                            <div class="row no-gutters p-3">
                              ...
                              <div class="col-12 py-3  d-flex justify-content-end align-content-center">
                                ...
                                <button type="buttton" :disabled="isDisabled" class="btn btn-delete px-3 mx-2 d-flex align-content-center" @click="deleteItem(item.id)">
                                  <img class="mr-2" :src="
                                                                images.delete_modal
                                                            " />
                                  Delete
