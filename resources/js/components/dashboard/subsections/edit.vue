                      ...
                      <div class="row no-no-gutters ">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select class="form-control" v-model="form.sub_section_id"  :class="{ 'is-invalid': form.errors.has('sub_section_id') }">
                                <option v-for="item in subsections" :key="item.id" :value="item.id">{{item.title}}</option>
                            </select>
                            <span v-if="errors.sub_section_id" class="error">{{ errors.sub_section_id[0] }}</span>
                          </div>
                          <div class="form-group">
                            <label>Title</label>
...
export default {
  ...
  methods: {
    ...
    creating() {
      ...
      formData.append("sub_section_id", this.form.sub_section_id);
      ...
      axios
        ...
        .then((res) => {
          ...
          this.$router.push({ path: "/admin/subsections/" });
          Toast.fire({
            icon: "success",
