                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select
                              ...
                              :class="{ 'is-invalid': form.errors.has('sub_section_id') }"
                            >
                              <option
...
<!--                            >-->
<!--                              <option-->
<!--                                v-for="item in subsectionssub"-->
<!--                                :key="item.id"-->
<!--                                :value="item.id"-->
<!--                              >{{item.title}}</option>-->
<!--                            </select>-->
                            <span
                              v-if="errors.sub_section_id"
                              class="error"
                            >{{ errors.sub_section_id[0] }}</span>
                          </div>
                          <div class="form-group">
                            <label>Title</label>
                            <input
                        ...
                        <div class="col-md-12 mt-3 text-right">
                          ...
                          <div class="form-group ">
                            ...
                            <span
                              v-if="errors.title_ar"
                              class="error"
                            >{{ errors.title_ar[0] }}</span>
                          ...
                          <div class="form-group">
                            ...
                            <textarea
                              ...
                              class="form-control text-right"
                              :class="{ 'is-invalid': form.errors.has('content_ar') }"
                              rows="7"
                              placeholder="ادخل المحتوى"
                              name="content_ar"
                            ></textarea>
                            <span
                              v-if="errors.content_ar"
                              class="error"
                            >{{ errors.content_ar[0] }}</span>
                          </div>
                        </div>
                      </div>
                    </form>
