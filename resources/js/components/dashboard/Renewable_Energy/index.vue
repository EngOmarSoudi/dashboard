                        ...
                        <div class="col-12 ">
                            <div class="head-fixed">
                                <div class="min-div px-4 py-3">
                                    ...
                                    @click="NewModel()"
                                >
                                    Add renewable energy categories
                                </button>
                            ...
                            <div class="min-div px-4 py-3 my-5">
                                <div class="d-flex">
                                    ...
                                    <router-link
                                            to="/admin/renewable-energy/create"
                                            class="ml-auto"
                                            v-if="renewable_categories.length"
                                        >
                                            <img
                                                :src="images.icon_add"
                                                class="btn p-0"
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h5
                                                        ...
                                                        id="exampleModalLabel"
                                                    >
                                                        Edit renewable energy categories
                                                    </h5>
                                                </div>
                                ...
                                <div class="min-div_list_item mt-4"   v-for="(category, index) in renewable_categories"
                                        :key="index">
                                        <div class="d-flex">
                                            <div class="d-block">
                                            ...
                                            <div class="d-flex ml-auto">
                                                ...
                                                <div
                                                        ...
                                                        data-toggle="modal"
                                                        :data-target="
                                                            '#deletecategoryModal' + category.id
                                                        "
                                                    >
                                                        <svg
                                                            id="Delete_sm_"
                                    ...
                                    <div
                                        ...
                                        v-for="(item, i) in renewable"
                                        :key="i"
                                        v-if="item.renewable_categories_id == category.id"
                                    >
                                        <img
                                            class="min-div_list_item_img col-md-3"
                                            :src="
                                                'images/' + item.photo.filename
                                            "
                                        />
                                        <div
                                            class="card-body col-md-9 py-2 px-4 position-relative"
                                        >
                                            ...
                                            <div class="text-right pb-4">
                                                ...
                                                >
                                                <h4
                                                    class="min-div_list_item_title"
                                                >
                                                    {{ item.title_ar }}
                                                </h4>
                                                <p
                                                    class="min-div_list_item_text"
                                                >
                                                    {{ item.content_ar }}
                                                </p>
                                            </div>
...
export default {
    ...
    methods: {
        ...
        creating() {
            ...
            axios
                .post("api/renewable_categories", formData)
                .then(res => {
                    this.errors = [];
        ...
        updateing(id) {
            ...
            axios
                .post("api/renewable_categories/" + this.form.id, formData)
                .then(res => {
                    this.errors = [];
                    $("#saveModal").modal("hide");
                    $("#createModal").modal("hide");
        ...
        displayCategoriesItems() {
            axios.get("api/renewable_categories").then(response => {
                this.renewable_categories = response.data;
            });
        },
         displayItems() {
            axios.get("api/renewable").then(response => {
        ...
        deleteCategoryItem(id){
            this.isDisabled = true;
            axios
                .delete("api/renewable_categories/" + id)
                .then(res => {
