            ...
            <div class="col-12 ">
              <div class="head-fixed">
                <div class="min-div px-4 py-3">
                  ...
                  <div class="min-div_list_icon">
                    ...
                    <router-link to="/admin/stories/create">
                      <img :src="images.icon_add" class="btn" v-b-popover.hover.top="'Add a story'" />
                    </router-link>
                  </div>
                </div>
              </div>
              ...
              <div class="min-div px-4 py-3 my-5">
                ...
                <div class="min-div_list_item mt-4">
                  <div class=" row no-gutters my-4 position-relative" v-for="(item, i) in filteredList" :key="i" v-show="item.ispinned == 1">
                    <img class="min-div_list_item_img col-md-3" :src="'images/'+ item.photo.filename" />
                    <div class="card-body col-md-9 py-2 px-4">
                      ...
                      <div class="d-flex justify-content-end" style="position: absolute; bottom: 8px; right: 0 ">
                        <img :src="images.show_img" width="22px" v-show="item.ispinned == 1" class="btn-card_show mx-3" @click="isNotpinned(item.id)" />
                        <img :src="images.hide_img" width="22px" v-show="item.ispinned == 0" class="btn-card_show mx-3" @click="ispinned(item.id)" />

                        <div class="btn-card_edit mx-3">
                          <router-link :to="'/admin/stories/edit/' + item.id">
                        ...
                        <router-link :to="'/admin/stories/view/' + item.id">
                          <button type="button" class="btn btn-save  mx-2 mb-1 px-3">
                            View
                          </button>
                        </router-link>
                      </div>
              ...
              <div class="min-div px-4 py-3 my-5">
                ...
                <div class="min-div_list_item mt-4">
                  <div class=" row no-gutters my-4 position-relative" v-for="(item, i) in filteredList" :key="i" v-show="item.ispinned == 0 || 1">
                    <img class="min-div_list_item_img col-md-3" :src="'images/'+ item.photo.filename" style="height: 200px;" />
                    <div class="card-body col-md-9 py-2 px-4">
                      <h4 class="min-div_list_item_title">
                        {{ item.title }}
                      </h4>
...
export default {
  ...
  methods: {
    ...
    ispinned(id) {
      setTimeout(() => this.displayItems(), 2000);
      axios.put("api/storyIsPinned/" + id).then((res) => {
        Toast.fire({
          icon: "success",
