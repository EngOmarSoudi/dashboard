                        ...
                        <div class="col-12 ">
                            ...
                            <div class="min-div px-4 py-3 my-5">
                                <div class="d-flex">
                                    ...
                                    <router-link
                                            to="/admin/agriculture/create"
                                            class="ml-auto"
                                            v-if="agriculture_categories.length"
                                        >
                                            <img
                                                :src="images.icon_add"
                                                class="btn p-0"
                                ...
                                <div class="min-div_list_item mt-4"   v-for="(category, index) in agriculture_categories"
                                        :key="index">
                                        <div class="d-flex">
                                            <div class="d-block">
                                    ...
                                    <div
                                        ...
                                        v-for="(item, i) in agriculture"
                                        :key="i"
                                        v-if="item.agriculture_categories_id == category.id"
                                    >
                                        <img
...
export default {
    ...
    methods: {
        ...
        creating() {
            ...
            axios
                .post("api/agriculture_categories", formData)
                .then(res => {
                    this.errors = [];
        ...
        updateing(id) {
            ...
            axios
                .post("api/agriculture_categories/" + this.form.id, formData)
                .then(res => {
                    this.errors = [];
                    $("#saveModal").modal("hide");
                    $("#createModal").modal("hide");
        ...
        displayCategoriesItems() {
            axios.get("api/agriculture_categories").then(response => {
                this.agriculture_categories = response.data;
            });
        },
         displayItems() {
            axios.get("api/agriculture").then(response => {
        ...
        deleteCategoryItem(id){
            this.isDisabled = true;
            axios
                .delete("api/agriculture_categories/" + id)
                .then(res => {
