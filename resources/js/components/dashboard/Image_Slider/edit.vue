...
export default {
  ...
  methods: {
    getItemImage() {
      return "images/imageslider/"+ this.form.image;
    },
    upload_image(e) {
    ...
    creating() {
      ...
      formData.append("GI", this.form.GI);
      formData.append("image", this.form.image);
      formData.append("_method", "put");
      let id = this.$route.params.id;
      axios
        .post("api/imageslide/" + id, formData, {
          headers: {
    ...
    loadItem() {
      let id = this.$route.params.id;
      axios.get("api/imageslide/" + id).then((response) => {
