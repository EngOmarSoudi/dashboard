                ...
                <div class="min-div px-4 py-3">
                  ...
                  <div class="min-div_list_icon">
                    ...
                    <router-link to="/admin/account/create">
                      <img :src="images.icon_add" class="btn" v-b-popover.hover.top="'Add an Account'" />
                    </router-link>
                  </div>
                </div>
              </div>
              ...
              <div class="min-div px-4 py-3 my-5">
                ...
                <div class="min-div_list_item mt-4">
                  <div class=" row no-gutters my-4">
                    <div class="col-md-3 p-2" v-for="item in filteredList" :key="item.id">

                      <router-link :to="'/admin/account/view/' + item.id">
                        <img class="min-div_list_item_img " :src="'/images/user/'+getFileName(item.photo) " />
<!--                          item.photo.filename-->
                      </router-link>
                      <div class="card-body px-0  py-2 " style=" position: relative;">
                        ...
                        <div class="d-flex justify-content-end" style=" position: absolute; top: 8px; right: 8px;">
                          <div class="btn-card_edit mx-2" style=" width:25px; height:25px">

                            <router-link type="info" :to="'/admin/account/edit/'+ item.id">
                          ...
                          <div class="btn-card_delete mx-2" style=" width:25px; height:25px" data-toggle="modal" :data-target="'#deleteModal' + item.id">
                            ...
                            <form>
                              ...
                              <div class="row no-gutters p-3">
                                ...
                                <div class="col-12 py-3  d-flex justify-content-end align-content-center">
                                  ...
                                  <button type="submit" :disabled="isDisabled" class="btn btn-delete px-3 mx-2 d-flex align-content-center" @click="deleteItem(item.id)">
                                    <img class="mr-2" :src="
                                                                    images.delete_modal
                                                                " />
                                    Delete
    ...
    filteredList() {
      if (this.search) {
        return this.users.filter((item) => {
          return item.first_name.startsWith(this.search);
        });
      } else {
        return this.users;
      }
