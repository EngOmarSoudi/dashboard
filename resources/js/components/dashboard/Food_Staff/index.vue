                        ...
                        <div class="col-12 ">
                            ...
                            <div class="min-div px-4 py-3 my-5">
                                <div class="d-flex">
                                    ...
                                    <router-link
                                            to="/admin/food-staff/create"
                                            class="ml-auto"
                                            v-if="food_categories.length"
                                        >
                                            <img
                                                :src="images.icon_add"
                                                class="btn p-0"
                                ...
                                <div class="min-div_list_item mt-4"   v-for="(category, index) in food_categories"
                                        :key="index">
                                        <div class="d-flex">
                                            <div class="d-block">
                                    ...
                                    <div
                                        ...
                                        :key="i"
                                        v-if="item.food_categories_id == category.id"
                                    >
                                        <img
...
export default {
    ...
    methods: {
        ...
        creating() {
            ...
            axios
                .post("api/food_categories", formData)
                .then(res => {
                    this.errors = [];
        ...
        updateing(id) {
            ...
            axios
                .post("api/food_categories/" + this.form.id, formData)
                .then(res => {
                    this.errors = [];
                    $("#saveModal").modal("hide");
                    $("#createModal").modal("hide");
        ...
        displayCategoriesItems() {
            axios.get("api/food_categories").then(response => {
                this.food_categories = response.data;
            });
        },
         displayItems() {
